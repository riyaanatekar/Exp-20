...
Conclusion:
This experiment helped in analyzing real-world COVID-19 data using Pandas. 
It improved understanding of data cleaning, grouping, filtering, and visualization techniques.
It also demonstrated how to extract meaningful insights such as active cases, country-wise analysis, and time-based trends.
